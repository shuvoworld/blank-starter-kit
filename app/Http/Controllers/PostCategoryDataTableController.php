...
class PostCategoryDataTableController extends BaseDataTableController
{
    ...
    {
        return [
            'updated_by_name' => fn (PostCategory $postCategory) => $postCategory->updatedBy?->name ?? '—',
        ];
    }
        ...
        return '
            <div class="btn-group btn-group-sm">
                ...
                <button type="button" class="btn btn-danger btn-delete"
                    data-url="'.$deleteUrl.'"
                    data-name="'.e($postCategory->name).'" title="Delete">
