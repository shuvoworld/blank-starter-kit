        ...
        <div class="col-lg-4">
            ...
            @can('delete designations')
                <div class="card card-danger card-outline">
                    ...
                    <div class="card-body">
                        <p class="text-muted small">Once deleted, this designation record cannot be recovered.</p>
                        <form action="{{ route('designations.destroy', $designation) }}" method="POST" class="d-inline"
                              onsubmit="return confirm('Are you sure you want to delete {{ $designation->name }}?')">
                            @csrf
                            @method('DELETE')
