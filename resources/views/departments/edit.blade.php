                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          ...
                                          rows="4" placeholder="Department description">{{ old('description', $department->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
        ...
        <div class="col-lg-4">
            ...
            @can('delete departments')
                <div class="card card-danger card-outline">
                    ...
                    <div class="card-body">
                        <p class="text-muted small">Once deleted, this department record cannot be recovered.</p>
