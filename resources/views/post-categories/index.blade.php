...
@section('content')
    <div class="card">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                @can('create post categories')
                    <a href="{{ route('post-categories.create') }}" class="btn btn-primary">
                        <i class="bi bi-plus-lg me-1"></i> Add Post Category
                    </a>
                @endcan
            </div>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="post-categories-table" class="table table-bordered table-hover table-striped w-100">
                    <thead>
                    <tr>
    ...
    @push('scripts')
        <script>
            ...
            function initPostCategoryDataTable() {
                if (typeof $ !== 'undefined' && typeof bootstrap !== 'undefined') {
                    $(document).ready(function () {
                        var table = $('#post-categories-table').DataTable({
                            processing: true,
                            serverSide: true,
                            responsive: true,
                            ajax: {
                                url: '{{ route('post-categories.datatable') }}',
                                type: 'GET'
                            },
                            columns: dtColumns,
                            order: [[1, 'asc']],
                            ...
                            language: {
                                ...
                                search: '_INPUT_',
                                searchPlaceholder: 'Search post categories...',
                                lengthMenu: 'Show _MENU_',
                                info: 'Showing _START_ to _END_ of _TOTAL_ post categories',
                                infoEmpty: 'No post categories found',
                                ...
                                emptyTable: '<div class="text-center py-4"><i class="bi bi-grid fs-1 text-muted"></i><p class="text-muted mt-2">No post categories found</p></div>'
                            },
                        ...
                        $('#confirmDelete').on('click', function () {
                            ...
                            $.ajax({
                                ...
                                success: function () {
                                    ...
                                    showToast('success', 'Post Category deleted successfully.');
                                },
                                error: function (xhr) {
                                    deleteModal.hide();
                    ...
                    setTimeout(initPostCategoryDataTable, 100);
                }
            }

            initPostCategoryDataTable();
        </script>
    @endpush
@endsection
