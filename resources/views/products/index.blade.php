    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="products-table" class="table table-bordered table-hover table-striped w-100">
                    <thead>
                        <tr>
                    ...
                    $(document).ready(function () {
                        var table = $('#products-table').DataTable({
                            ...
                            language: {
                                ...
                                emptyTable: '<div class="text-center py-4"><i class="bi bi-box-seam fs-1 text-muted"></i><p class="text-muted mt-2">No products found</p></div>'
                            },
