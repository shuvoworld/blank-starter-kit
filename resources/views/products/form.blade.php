...
@section('header')
    <h1 class="m-0">{{ $editing ? 'Edit Product' : 'Add Product' }}</h1>
@endsection
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        {{ $editing ? 'Edit Product: '.$record->name : 'New Product' }}
                    </h3>
                </div>
                <form action="{{ $editing ? route('products.update', $record) : route('products.store') }}"
                      method="POST">
                    @csrf
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('sku') is-invalid @enderror"
                                       id="sku" name="sku" value="{{ old('sku', $record?->sku) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('price') is-invalid @enderror"
                                           id="price" name="price" value="{{ old('price', $record?->price) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('stock') is-invalid @enderror"
                                       id="stock" name="stock" value="{{ old('stock', $record?->stock ?? 0) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror"
                                      ...
                                      placeholder="Product description (optional)">{{ old('description', $record?->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                @can('delete products')
                    <div class="card card-danger card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('products.destroy', $record) }}" method="POST" class="d-inline"
