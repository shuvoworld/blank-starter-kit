...
@section('header')
    <h1 class="m-0">Superuser Dashboard</h1>
@endsection
                    ...
                    <div class="card-body">
                        ...
                        <div class="progress mb-2">
                            <div class="progress-bar bg-success"
                                 style="width: {{ $leaveRequestsStats['total'] > 0 ? ($leaveRequestsStats['approved'] / $leaveRequestsStats['total'] * 100) : 0 }}%"></div>
                            <div class="progress-bar bg-warning"
                                 style="width: {{ $leaveRequestsStats['total'] > 0 ? ($leaveRequestsStats['pending'] / $leaveRequestsStats['total'] * 100) : 0 }}%"></div>
                            <div class="progress-bar bg-danger"
                                 style="width: {{ $leaveRequestsStats['total'] > 0 ? ($leaveRequestsStats['rejected'] / $leaveRequestsStats['total'] * 100) : 0 }}%"></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <strong class="text-success">{{ $stats['approvedToday'] ?? 0 }}</strong>
                                </div>
        ...
        <div class="col-md-4">
            ...
            <div class="card card-primary card-outline mb-3">
                <div class="card-body box-profile">
                    ...
                    <p class="text-muted text-center">Superuser</p>
