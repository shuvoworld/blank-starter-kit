...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <div class="card card-success card-outline mb-3">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="bi bi-bar-chart me-1"></i> Sales Chart
                </h3>
                <div class="card-tools float-right">
    ...
    <div class="col-md-4">
        ...
        <div class="card card-success card-outline mb-3">
            ...
            <div class="card-body">
                ...
                <hr>
                <strong><i class="bi bi-shield me-1"></i> Roles</strong>
                <p>
                    @foreach(Auth::user()->roles as $role)
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-warning card-outline mb-3">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="bi bi-box-seam me-1"></i> Recent Products
                    </h3>
                    <div class="card-tools float-right">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                @forelse($stats['recentProducts'] ?? collect(), as $product)
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>
