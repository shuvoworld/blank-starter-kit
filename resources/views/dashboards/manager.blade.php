...
<div class="row">
    <div class="col-12 col-sm-6 col-md-4">
        <div class="info-box">
            <span class="info-box-icon bg-info elevation-1"><i class="bi bi-person-badge"></i></span>
    ...
    <div class="col-12 col-sm-6 col-md-4">
        <div class="info-box">
            <span class="info-box-icon bg-success elevation-1"><i class="bi bi-box-seam"></i></span>
            <div class="info-box-content">
...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <div class="card card-success card-outline mb-3">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="bi bi-bar-chart me-1"></i> Team Overview
                </h3>
                <div class="card-tools float-right">
            ...
            <div class="card-body">
                <div class="chart">
                    <canvas id="teamChart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>
                </div>
            </div>
        </div>
        ...
        <div class="card card-primary card-outline mb-3">
            <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                    ...
                    <li class="list-group-item">
                        <b>Team Size</b> <a class="float-right">{{ $stats['employees'] ?? 0 }}</a>
                    </li>
                    <li class="list-group-item">
...
<script>
  $(function () {
    ...
    var teamChartCanvas = document.getElementById('teamChart').getContext('2d')
