...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table id="leave-types-table" class="table table-bordered table-hover table-striped w-100">
                <thead>
                    <tr>
                        <th width="50">#</th>
                        <th>Code</th>
...
@push('scripts')
<script>
    function initLeaveTypesDataTable() {
        if (typeof $ !== 'undefined' && typeof bootstrap !== 'undefined') {
            $(document).ready(function() {
                var table = $('#leave-types-table').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'code_badge', name: 'code', orderable: true, searchable: true, className: 'text-center'},
                        {data: 'name', name: 'name'},
                        {data: 'is_paid_badge', name: 'is_paid', orderable: true, searchable: false, className: 'text-center'},
                        {data: 'max_days_per_year', name: 'max_days_per_year', className: 'text-center'},
                        {data: 'carry_forward_badge', name: 'carry_forward', orderable: false, searchable: false, className: 'text-center'},
                    ...
                    language: {
                        ...
                        infoEmpty: 'No leave types found',
                        ...
                        emptyTable: '<div class="text-center py-4"><i class="bi bi-calendar-check fs-1 text-muted"></i><p class="text-muted mt-2">No leave types found</p></div>'
                    },
            ...
            setTimeout(initLeaveTypesDataTable, 100);
        }
    }

    initLeaveTypesDataTable();
</script>
@endpush
@endsection
