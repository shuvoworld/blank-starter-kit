...
@section('header')
    <h1 class="m-0">Employee Categories</h1>
@endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
    <li class="breadcrumb-item active" aria-current="page">Employee Categories</li>
@endsection
...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="employee-categories-table" class="table table-bordered table-hover table-striped w-100">
                    <thead>
                    <tr>
    ...
    @push('scripts')
        <script>
            ...
            function initEmployeeCategoryDataTable() {
                if (typeof $ !== 'undefined' && typeof bootstrap !== 'undefined') {
                    $(document).ready(function () {
                        var table = $('#employee-categories-table').DataTable({
                            processing: true,
                            serverSide: true,
                            responsive: true,
                            ajax: {
                                url: '{{ route('employee-categories.datatable') }}',
                                type: 'GET'
                            },
                            columns: dtColumns,
                            order: [[1, 'asc']],
                            ...
                            language: {
                                ...
                                info: 'Showing _START_ to _END_ of _TOTAL_ employee categories',
                                infoEmpty: 'No employee categories found',
                                ...
                                emptyTable: '<div class="text-center py-4"><i class="bi bi-grid fs-1 text-muted"></i><p class="text-muted mt-2">No employee categories found</p></div>'
                            },
                        ...
                        $('#confirmDelete').on('click', function () {
                            ...
                            $.ajax({
                                ...
                                success: function () {
                                    ...
                                    showToast('success', 'Employee Category deleted successfully.');
                                },
                                error: function (xhr) {
                                    deleteModal.hide();
                    ...
                    setTimeout(initEmployeeCategoryDataTable, 100);
                }
            }

            initEmployeeCategoryDataTable();
        </script>
    @endpush
@endsection
